...
function chamar_css($nomePagina)
{
	$baseUrl = base_url();
	$linkCss = '<link rel="stylesheet" href="' . $baseUrl . 'assets/css/' . $nomePagina . '.css">';
	return $linkCss;
}
function chamar_js($nomePagina)
{
	$baseUrl = base_url();
	$linkJs = '<script src="' . $baseUrl . 'assets/js/' . $nomePagina . '.js"></script>';
	return $linkJs;
}
