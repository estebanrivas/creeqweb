                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="table-responsive table--no-card">
                                <?php
                                $this->table->set_heading("Patrimônio", "Unidade", "Usuário", "Tp.Equip.", "Teamviewer", "Opções");
                                foreach ($equipamentos as $equipamento) {
                                    ...
                                    $this->table->add_row($numpatrimonio, $nomeunidade, $nomeusuario, $nometpequipamento, $nometeamviewer, $alterar . '&nbsp&nbsp' .$excluir . '&nbsp&nbsp' . $detalhes);
                                }
