                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="row m-b-15">
                                <a href="exportaexcelcftv"><button class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Exportação para Excel"><i class="zmdi zmdi-download"></i> Exportação para Excel</button></a>
                            </div>
                            <div class="table-responsive table--no-card">
                                <?php
                                $this->table->set_heading("#","Patrimônio", "IP", "Unidade", "HOST", "TIPO", "Localização", "OPÇÕES");
                                $this->table->set_template(array(
                                    'table_open' => '<table id="memListOutsourcingcftv" class="table table-borderless table-striped table-earning">'
                                ));
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select id="select-tpequipamento" name="select-tpequipamento" disabled class="form-control" autofocus>
                                                <option value=""><?= $equipamento->tpequipamento ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="txt-teamviewer" name="txt-teamviewer" disabled value="" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="txt-descricaoequipamento" name="txt-descricaoequipamento" disabled value="" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="txt-serial" name="txt-serial" disabled value="" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label id="txt-processador"><strong>Processador</strong></label>
                                            <input type="text" id="txt-processador" name="txt-processador" disabled value="" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="txt-telamonitor" name="txt-telamonitor" disabled value="" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label id="txt-hd"><strong>HD</strong></label>
                                            <input type="text" id="txt-hd" name="txt-hd" disabled value="" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label id="txt-ram"><strong>RAM</strong></label>
                                            <input type="text" id="txt-ram" name="txt-ram" disabled value="" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="txt-macwifi" name="txt-macwifi" disabled value="" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label id="txt-macbluetooth"><strong>MAC BLUETOOTH</strong></label>
                                            <input type="text" id="txt-macbluetooth" name="txt-macbluetooth" disabled value="" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
