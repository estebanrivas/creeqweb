            ...
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    ...
                    <div class="row m-b-15">
                        <a href="exportaexcelsugerida"><button class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Exportação para Excel"><i class="zmdi zmdi-download"></i> Exportação para Excel</button></a>
                    </div>
                    <div class="table-responsive table--no-card">
                        <?php
                        $this->table->set_heading("Patrimônio", "Unidade", "Usuário", "Tp.Equip.", "Modelo", "Status", "Opções");
                        foreach ($equipamentos as $equipamento) {
                            ...
                            $nomemodelo = $equipamento->modelo;
                            $nomestatus = $equipamento->statussesc;
                            ...
                            echo $modal = ' <div class="modal fade detalhes-modal-' . $equipamento->idequipamento . '" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
                            ...
                            $this->table->add_row($numpatrimonio, $nomeunidade, $nomeusuario, $nometpequipamento, $nomemodelo, $nomestatus, $alterar . '&nbsp&nbsp' . $detalhes);
                        }
