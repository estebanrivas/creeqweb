                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs nav-pills" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="desktopnotebook-tab" data-toggle="tab" href="#desktopnotebook" role="tab" aria-controls="desktopnotebook" aria-selected="false"><i class="fas fa-laptop"></i> Desktop / Notebook</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-content pl-3 p-1" id="myTabContent">
                                ...
                                <div class="tab-pane fade" id="desktopnotebook" role="tabpanel" aria-labelledby="desktopnotebook-tab">
                                    <h3 class="mt-2"><i class="fas fa-laptop"></i> Desktop / Notebook</h3>
                                    <hr>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
