                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <h3 class="title-5 m-b-35">Listagem Geral de
                                <?php echo $subtitulo ?>
                            </h3>
                            <div class="row m-b-15">
                                <a href="<?php echo base_url('equipamentos/exportaexcel') ?>"><button class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Exportação para Excel"><i class="zmdi zmdi-download"></i> Exportação para Excel</button></a>
                            </div>
                            <div class="table-responsive table--no-card">
                                <?php
                                $this->table->set_heading("Serial", "IP", "Unidade", "Host", "Localização", "Opções");

                                foreach ($equipamentos as $equipamento) {
                                    // $paraping = exec("ping -n 1 -w 1 " . $nomehost, $output, $result);
                                    ...
                                    // TESTA O RESULTADO DO PING
                                    // if ($result == 0) {
                                    //     $statushost = '<span class="badge badge-success">ONLINE</span>';
                                    // } else {
                                    //     $statushost = '<span class="badge badge-danger">OFFLINE</span>';
                                    // }
                                    $nomeenderecoip = anchor('http://' . $equipamento->ip, $equipamento->ip, ['title' => 'IP', 'class' => 'btn btn-info btn-sm item', 'data-ttt' => 'tooltip', 'data-placement' => 'right', 'target' => '_blank']);
                                    ...
                                    $this->table->add_row($numserial, $nomeenderecoip, $nomeunidade, $nomehost, $nomelocalizacao, $alterar . '&nbsp&nbsp' . $detalhes);
                                }
