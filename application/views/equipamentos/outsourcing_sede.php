                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="row m-b-15">
                                <a href="<?php echo site_url(); ?>outsourcing/createExceloutsede"><button class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Exportação para Excel"><i class="zmdi zmdi-download"></i> Exportação para Excel</button></a>
                            </div>
                            <div class="table-responsive table--no-card">
                                <?php
                                $this->table->set_heading("#", "Patrimônio", "Serial", "IP", "Unidade", "HOST", "Localização", "OPÇÕES");
                                $this->table->set_template(array(
                                'table_open' => '<table id="memListOutsourcingsede" class="table table-borderless table-striped table-earning">'
