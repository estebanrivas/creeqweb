                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="table-responsive table--no-card m-t-20">
                                <?php
                                $this->table->set_heading("ID", "Patrimônio", "Unidade", "Usuário", "Tipo", "Teamviewer", "OPÇÕES");
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>Deseja Excluir o Equipamento de patrimônio <?php echo $equipamento->patrimonio ?>  ?</h4>
                    <p>Após Excluido o Equipamento de patrimônio <b><?php echo $equipamento->patrimonio ?></b>, o mesmo não ficara mais disponível no Sistema.</p>
                    <p>Todos os itens relacionados ao equipamento de <b><?php echo $equipamento->patrimonio ?></b> serão afetados e não aparecerão no sistema até que sejam editados.</p>
                </div>
