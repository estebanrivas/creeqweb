            ...
            <div class="row">
                <div class="col-md-4 col-lg-4">
                    ...
                    <div class="alert alert-warning" role="alert">
                        ...
                        <strong>
                            <p>Antes de cadastrar, é necessário ter o equipamento cadastrado!!! - Aplicado a Desktop e Notebook.</p>
                        </strong>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <strong><?php echo 'Cadastro de ' . $subtitulo ?> - Aplicado a Desktop e Notebook.</strong><br>
                        </div>
                ...
                <div class="col-md-8 col-lg-8">
                    ...
                    <div class="table-responsive table--no-card">
                        <?php
                        $this->table->set_heading("Código", "Patrimônio", "Sala", "Unidade", "Opções");
                        foreach ($cadeados as $cadeado) {

                            $nomecod            = $cadeado->codigo;
                            $nomepatrimonio     = $cadeado->patrimonio;
                            $nomeusuario        = $cadeado->usuario;
                            $nomeunidade        = $cadeado->unidade;
                            $nomesala           = $cadeado->localizacao;
                                ...
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        <div class="modal-header btn-warning">
                                            <h5 class="modal-title" id="mediummodalLabel">Detalhes do Cadeado</h5>
                            ...
                            $this->table->add_row($nomecod, $nomepatrimonio, $nomesala, $nomeunidade, $alterar . '&nbsp&nbsp' . $excluir . '&nbsp&nbsp' . $detalhes);
                        }
