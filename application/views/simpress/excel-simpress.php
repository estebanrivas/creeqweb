    <?php
        $this->table->set_heading("Id", "Tipo", "Modelo", "Serial", "Host", "IP", "Mac LAN", "Regional", "Unidade", "Conexão", "Localização", "Status", "Fabricante");
        foreach ($equipamentos as $equipamento) {
            ...
            $this->table->add_row($idequip, $tipoequip, $modelo, $serial, $host, $ip, $mac, $regional, $unidade, $conexao, $localizacao, $status, $fabricante);
        }
