                        ...
                        <div class="col-md-6 col-lg-6">
                            <h3 class="title-5 m-b-35">Alterar <?php echo $subtitulo ?></h3>
                                <div class="table-responsive table--no-card">
                                        <?php
                                        $this->table->set_heading("Status", "Opções");
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p>Após Excluido o Status <b>'. $statu->status .'</b> não ficara mais disponível no Sistema.</p>
                                                        <p>Todos os itens relacionados ao Status <b>'. $statu->status .'</b> serão afetados e não aparecerão no sistema até que sejam editados.</p>
                                                    </div>
