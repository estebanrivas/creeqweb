...
class Geral extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->equipamentos = $this->modelequipamentos->lista_geral();
        ...
        $this->load->view('equipamentos/listageral');
    ...
    public function exportaexcel()
    {
        ...
        $this->load->view('templates/html-header-exportartodos', $dados);
        $this->load->view('equipamentos/excel-geral');
