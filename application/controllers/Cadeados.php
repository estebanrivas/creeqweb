...
class Cadeados extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('cadeados/cadeados');
    ...
    public function alterar($idcadeados)
    {
        ...
        // $dados['patrimoniosSesc'] = $this->modelcadeados->lista_patrimonio_usuario();
        $dados['chamadaJS'] = chamar_js('cadeadosalterar');
    ...
    public function autocompleteData()
    {
        ...
        $patrimonioData = $this->modelcadeados->getPatrimonios1($conditions);

        // Generate array
        if (!empty($patrimonioData)) {
            foreach ($patrimonioData as $row) {
